trait AppTests
{
  ...
  def test2015_11_20() = T.command {
    ...
    check(runProblem("2015_12_1")(), "119433")
    check(runProblem("2015_12_2")(), "68466")

    check(runProblem("2015_13_1")(), "618")
    check(runProblem("2015_13_2")(), "601")

    check(runProblem("2015_14_1")(), "2660")
    check(runProblem("2015_14_2")(), "1256")

    check(runProblem("2015_15_1")(), "13882464")
    check(runProblem("2015_15_2")(), "11171160")

    check(runProblem("2015_16_1")(), "103")
    check(runProblem("2015_16_2")(), "405")

    check(runProblem("2015_17_1")(), "4372")
    check(runProblem("2015_17_2")(), "4")

    check(runProblem("2015_18_1")(), "821")
    check(runProblem("2015_18_2")(), "886")

    check(runProblem("2015_19_1")(), "576")
    check(runProblem("2015_19_2")(), "207")

    check(runProblem("2015_20_1")(), "665280")
    check(runProblem("2015_20_2")(), "705600")
  }

  def test2015_21_25() = T.command {
    check(runProblem("2015_21_1")(), "121")
    check(runProblem("2015_21_2")(), "201")

    check(runProblem("2015_22_1")(), "1824")
    check(runProblem("2015_22_2")(), "1937")

    check(runProblem("2015_23_1")(), "307")
    check(runProblem("2015_23_2")(), "160")

    check(runProblem("2015_24_1")(), "11266889531")
    check(runProblem("2015_24_2")(), "77387711")

    check(runProblem("2015_25_1")(), "9132360")
    check(runProblem("2015_25_2")(), "0")
  }
  ...
  def test2016_11_20() = T.command {
    ...
    check(runProblem("2016_12_1")(), "318020")
    check(runProblem("2016_12_2")(), "9227674")

    check(runProblem("2016_13_1")(), "90")
    check(runProblem("2016_13_2")(), "135")
  }
  ...
  def test2017_11_20() = T.command {
    ...
    check(runProblem("2017_12_2")(), "195")

    check(runProblem("2017_13_1")(), "1632")
    check(runProblem("2017_13_2")(), "3834136")
    ...
    check(runProblem("2017_20_1")(), "344")
  ...
  def test2017_21_25() = T.command {
    ...
    check(runProblem("2017_24_1")(), "1511")
    check(runProblem("2017_24_2")(), "1471")

    check(runProblem("2017_25_1")(), "633")
    check(runProblem("2017_25_2")(), "0")
  }
  ...
  def test2018_11_20() = T.command {
    ...
    check(runProblem("2018_13_1")(), "111,13")
    check(runProblem("2018_13_2")(), "16,73")
  }
  ...
  def test2019_11_20() = T.command {
    ...
    check(runProblem("2019_13_1")(), "361")
    check(runProblem("2019_13_2")(), "17590")

    check(runProblem("2019_14_1")(), "892207")
    check(runProblem("2019_14_2")(), "1935265")

    check(runProblem("2019_15_1")(), "220")
    check(runProblem("2019_15_2")(), "334")

    check(runProblem("2019_16_1")(), "28430146")
    check(runProblem("2019_16_2")(), "12064286")

    check(runProblem("2019_17_1")(), "3336")
    check(runProblem("2019_17_2")(), "597517")

    check(runProblem("2019_18_1")(), "3856")
    check(runProblem("2019_18_2")(), "1660")

    check(runProblem("2019_19_1")(), "203")
    check(runProblem("2019_19_2")(), "8771057")

    check(runProblem("2019_20_1")(), "600")
    check(runProblem("2019_20_2")(), "6666")
  }

  def test2019_21_25() = T.command {
    check(runProblem("2019_21_1")(), "19354818")
    check(runProblem("2019_21_2")(), "1143787220")

    check(runProblem("2019_23_1")(), "27061")
    check(runProblem("2019_23_2")(), "19406")

    check(runProblem("2019_24_1")(), "32513278")
    check(runProblem("2019_24_2")(), "1912")

    check(runProblem("2019_25_1")(), "2415919488")
    check(runProblem("2019_25_2")(), "0")
  }
  ...
  def test2020_11_20() = T.command {
    ...
    check(runProblem("2020_13_1")(), "370")
    check(runProblem("2020_13_2")(), "894954360381385")

    check(runProblem("2020_14_1")(), "11884151942312")
    check(runProblem("2020_14_2")(), "2625449018811")
  }
